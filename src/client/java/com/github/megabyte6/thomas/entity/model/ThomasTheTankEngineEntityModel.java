...
public class ThomasTheTankEngineEntityModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        bb_main.addChild("TopChonk_r1", ModelPartBuilder.create().uv(19, 36)
                        .cuboid(-3.0F, -12.5F, -10.0F, 6.0F, 3.0F, 10.0F, new Dilation(0.0F)).uv(1, 40)
                        .cuboid(-3.0F, -8.0F, 10.0F, 6.0F, 6.0F, 1.0F, new Dilation(0.0F)).uv(24, 0)
                        .cuboid(-2.0F, -12.5F, 3.0F, 4.0F, 3.0F, 4.0F, new Dilation(0.0F)).uv(14, 28)
                        .cuboid(-5.0F, -3.5F, 4.5F, 2.0F, 3.0F, 3.0F, new Dilation(0.0F)).uv(32, 7)
                        .cuboid(3.0F, -3.5F, 4.5F, 2.0F, 3.0F, 3.0F, new Dilation(0.0F)).uv(27, 23)
                        .cuboid(3.0F, -5.5F, -8.5F, 2.0F, 5.0F, 5.0F, new Dilation(0.0F)).uv(0, 28)
                        .cuboid(-5.0F, -5.5F, -8.5F, 2.0F, 5.0F, 5.0F, new Dilation(0.0F)),
        ...
        bb_main.addChild("Body_r1",
                ...
                ModelTransform.of(0.0F, -10.0F, 0.0F, 1.5708F, 0.0F, 0.0F));
